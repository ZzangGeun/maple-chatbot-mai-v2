...
class CoreServicesTest(TestCase):
    ...
    @patch("core.services.get_api_data")
    @patch("core.services.os.path.exists")
    def test_get_notice_list_calls_api_when_no_cache(self, mock_exists, mock_get_api_data):
        ...
        with patch("core.services.save_notice_data_to_json"):
    ...
    @patch("core.services.load_notice_data_from_json")
    @patch("core.services.os.path.getmtime")
    @patch("core.services.os.path.exists")
    def test_get_notice_list_uses_cache(self, mock_exists, mock_getmtime, mock_load_data):
        ...
        with patch("core.services.get_api_data") as mock_get_api_data:
            result = get_notice_list()
